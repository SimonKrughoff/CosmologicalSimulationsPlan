...
%\tcr{ check with Rachel M/Tiziana if this is correctly stated}.
...
%\tcr{ Should we go through the SRM and list all the tasks that require simulations? I have marked them, so could do that.}
...
\tcr{From RB: Please can we include the specific simulation/catalog products that are going to be needed by each WG (or for a collection of WGs) as listed in the SRM and explicitly state which simulations will be used and which institutional groups are going to deliver them on what timescale (perhaps using a table summary).}
...
\tcr{From RB: To the level known,  please can we include the specific simulation/catalog products that are going to be needed by each WG (or for a collection of WGs) as listed in the SRM and explicitly state which simulations will be used and which institutional groups are going to deliver them on what timescale (perhaps using a table summary).}
