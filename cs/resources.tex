...
\tcr{From RB: Please can you include quantitative specifics about the estimated amount of resources that are going to be needed to complete the simulation needs for DC2 and DC3?}
...
The major groups involved in the efforts described in this document are (in alphabetical order): Argonne, Brazil, CMU, LBNL, Stanford, and UW. \tcr{ who else? how detailed?}  
